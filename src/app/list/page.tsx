        ...
        <div className='px-4 md:px-8 lg:px-16 xl:32 2xl:px-64 relative'>
            ...
            <div className="hidden bg-pink-50 px-4 sm:flex justify-between h-64">
                ...
                <div className="relative w-1/3">
                    <Image src="https://images.gr-assets.com/books/1447303603l/2767052.jpg" alt="" fill className="object-contain"/>
                </div>
            </div>
            {/*FILTER*/}
            <Filter/>
            {/*PRODUCTS*/}
            <h1 className="mt-12 text-xl font-semibold">Books For You</h1>
            <ProductList/>
        </div>
    )
}
